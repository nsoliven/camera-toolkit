...
/// whole stack at once. Right-click offers "Move to Trash" when the board
/// supports it.
struct StackPreviewOverlay: View {
    ...
    private var hintText: String {
        var text = "← → frames · ↑ ↓ items · click zoom · drag pan · + − 0 zoom · [ ] rotate · 1–9 sort · O open"
